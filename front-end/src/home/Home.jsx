      ...
      <section className="fullscreen d-flex flex-column">
        <div className="container py-5 px-4 px-lg-5 my-auto">
          <div className="row py-5 py-sm-4">
            <img
              ...
              src="https://storage.googleapis.com/seattle-wedding-magazine/seattle-wedding-magazine-black%20logo.png" 
            />
          </div>
          <div className="row py-5 py-sm-4">
            <div className="col-12 text-center mx-auto">
              <h1 className="text-9 text-white bg-danger d-inline-block font-weight-700 rounded px-3 py-2 mb-4">
                <strong>Coming Soon!</strong>
              </h1>
              <h2 className="mb-4">Our new website is on its way.</h2>
            </div>
            <div className="col-md-8 col-lg-6 col-xl-5 mx-auto text-center">
              <p className="text-muted mb-3">Get notified when we launch.</p>
        ...
        <footer className="container text-center">
          <p class="text-muted text-2 mb-2">
            Copyright &copy; 2021
            <a href="/">Seattle Wedding Magazine</a>
            . All Rights Reserved.
          </p>
        </footer>
      </section>
